...
def main():
    ...
    if os.path.exists("commands.txt"):
        cmd = ("python -m cProfile -s cumulative -o "
               "analysis_results/profile.prof main.py commands.txt")
        run_command(cmd, None)
        print("[OK] Профиль сохранен в analysis_results/profile.prof")
        print("  Для просмотра используйте:")
        print("  python -m pstats analysis_results/profile.prof")
    else:
